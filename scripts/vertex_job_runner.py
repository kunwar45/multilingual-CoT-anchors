...
Runs the experiment command, then uploads multicot/ output to GCS.

Usage (called by the Docker container entrypoint):
    python scripts/vertex_job_runner.py -- python -m multicot.generate_rollouts \
