<!-- ABOUTME: Bullet list of the project's claimed contributions, for reuse in applications and writeups. -->
<!-- ABOUTME: Prose summary of what is novel; no code or results live here. -->
