...
Usage:
    python -m src.rollout_importance.align_chunks --dataset mgsm --lang1 en --lang2 fr [--tau 0.6]
"""
...
# ---------------------------------------------------------------------------
# CLI Arguments (module-level, mirrors compute_importance.py pattern)
# ---------------------------------------------------------------------------
...
def translate_chunks_to_english(chunks: List[str], language: str) -> List[str]:
    ...
    from src.rollout_importance.data_loaders import LANGUAGE_NAMES
